...
## 2026-04-19 - Markdown Header Slugification for Navigation Links
**Learning:** GitHub-flavored Markdown slugification for headers containing emojis often strips the emoji and non-alphanumeric characters, typically resulting in a slug that starts with the first word (e.g., '## 📦 Core Components' becomes '#core-components'). Including a leading hyphen (e.g., '#-core-components') can result in broken internal links.
**Action:** Use simplified slugs (e.g., '#core-components') for internal links to emoji-prefixed headers to ensure consistent navigation across Markdown renderers.
