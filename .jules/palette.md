...
## 2025-05-16 - Internal Navigation for Complex Assets
**Learning:** For long documentation pages with complex visual assets, providing a direct "Jump to" link in the caption significantly improves the UX by allowing users to instantly navigate to detailed textual descriptions, reducing cognitive load and scrolling fatigue.
**Action:** Add a "Jump to detailed descriptions" link targeting the relevant anchor within the `<figcaption>` of complex diagrams.
