...
## 2026-04-25 - Documentation Navigation Interactivity
**Learning:** In documentation-heavy repositories, the "UX" is the reading experience. Mirroring instructional or structural recommendations from image alt text as actionable internal links within the `<figcaption>` creates a seamless "interactive" bridge between visual architecture and technical depth.
**Action:** Always provide explicit HTML anchors for key sections and use them in figure captions to allow users to immediately jump from a diagram component to its detailed text description.
