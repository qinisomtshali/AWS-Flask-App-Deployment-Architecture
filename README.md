...
<figure>
  <img
    ...
    height="1024"
  >
  <figcaption>Deployment architecture for a Flask application on AWS using ECS and ECR. View <a href="#core-components">Core Components</a> or <a href="#deployment-workflow">Deployment Workflow</a>.</figcaption>
</figure>
