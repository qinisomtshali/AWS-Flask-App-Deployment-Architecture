...
<figure>
  <!--
    Performance Optimization: architecture-diagram.webp was re-encoded using Pillow (Quality 80, method 6).
    Impact: Reduced file size from 344KB to 203KB (~41% reduction) to improve LCP.
  -->
  <img
