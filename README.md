...
<!--
  ...
  - Added fetchpriority="high" to prioritize the loading of this critical LCP element.
  - Removed redundant loading="eager" (default behavior).
  - Maintained explicit width/height to prevent Cumulative Layout Shift (CLS).
-->
<figure>
  <img
