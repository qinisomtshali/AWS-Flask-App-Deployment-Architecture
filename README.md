...
<!--
  ⚡ Bolt Optimization:
  - Explicit width/height (1024px) prevents Cumulative Layout Shift (CLS).
  - loading="eager" prioritizes this hero image for Largest Contentful Paint (LCP).
  - decoding="async" prevents the main thread from blocking during image decoding.
-->
<figure>
  <img
