...
<figure>
  <img
    ...
    height="1024"
  >
  <figcaption>Deployment architecture for a Flask application on AWS using ECS and ECR (<a href="#core-components">See detailed description below</a>).</figcaption>
</figure>
