...
<figure>
  <!--
    ...
    - Image compressed via Pillow (Quality 80, Method 6) for ~41% file size reduction.
    - fetchpriority="high" added to prioritize LCP (Largest Contentful Paint) for this critical diagram.
  -->
  <img
