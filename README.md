...
<figure>
  <img
    ...
    height="1024"
  >
  <figcaption>Deployment architecture for a Flask application on AWS. See <a href="#core-components">Core Components</a> and <a href="#deployment-workflow">Deployment Workflow</a>.</figcaption>
</figure>
