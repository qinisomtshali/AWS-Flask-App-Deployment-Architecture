...
<figure>
  <img
    ...
    height="1024"
  >
  <figcaption>Deployment architecture for a Flask application on AWS using ECS and ECR. See the <a href="#core-components">Core Components</a> section below for details.</figcaption>
</figure>
