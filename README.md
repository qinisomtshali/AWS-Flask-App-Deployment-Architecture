...
<figure>
  <!--
    Performance optimization: architecture-diagram.webp has been optimized using lossy WebP re-encoding
    (Quality 80, Method 6), reducing file size by ~41% (344KB to 203KB) to improve LCP.
  -->
  <img
