...
<figure>
  <img
    ...
    alt="AWS Flask Deployment Architecture: User -> ALB -> ECS Service (Docker) -> ECR (Image Store)"
    width="1024"
    height="1024"
    loading="eager"
    decoding="async"
  />
  <figcaption>High-level architecture diagram for Flask deployment on AWS using ECS and ECR.</figcaption>
</figure>
