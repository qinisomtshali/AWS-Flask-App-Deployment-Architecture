...
- **VPC & Subnets:** Provides the isolated network environment where the ECS tasks and ALB are deployed, ensuring secure and logical separation of resources.
- **Security Groups:** Act as virtual firewalls to control inbound and outbound traffic for the ALB and ECS tasks, maintaining network security.
