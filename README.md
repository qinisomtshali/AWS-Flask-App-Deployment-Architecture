...
<figure>
  <!-- LCP Optimization: architecture-diagram.webp was re-encoded using Pillow (Quality 70, Method 6)
       reducing size from 203KB to 167KB (~17.7% reduction) to improve Largest Contentful Paint. -->
  <img
