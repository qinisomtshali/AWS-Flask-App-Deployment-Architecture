...
<img src="architecture-diagram.webp" alt="Architecture diagram showing a user accessing a Flask application on AWS through an Application Load Balancer, ECS Service, and ECR." width="1024" height="1024" loading="lazy" decoding="async">
