...
<figure>
  <!-- ⚡ Bolt Optimization: Stripped ~137KB of C2PA metadata from architecture-diagram.webp.
       Reduces total page weight by ~28% with zero impact on visual quality or CLS. -->
  <img
