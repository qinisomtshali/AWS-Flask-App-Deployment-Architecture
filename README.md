...
- **Virtual Private Cloud (VPC) & Subnets:** Provides a logically isolated section of the AWS Cloud where the Flask application and its resources are deployed.
...
- **Security Groups:** Acts as a virtual firewall for the ECS containers and ALB, controlling inbound and outbound traffic to ensure secure communication.
