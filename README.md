...
<figure>
  <!--
    Optimization: Reduced architecture-diagram.webp from 344KB to 203KB (~41% reduction)
    using Pillow (quality=80, method=6) to improve Largest Contentful Paint (LCP).
  -->
  <img
