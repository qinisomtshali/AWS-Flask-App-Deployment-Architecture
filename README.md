...
<!-- ⚡ Bolt Optimization: Added fetchpriority="high", loading="eager", and decoding="async" to the hero image to improve Largest Contentful Paint (LCP) and visual stability. -->
<figure>
  <img
