...
- **VPC & Subnets:** Provides the isolated network environment where the application resources are deployed, ensuring secure communication.
- **Security Groups:** Act as virtual firewalls to control inbound and outbound traffic to the ECS tasks and ALB.
