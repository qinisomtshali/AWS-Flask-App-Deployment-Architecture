...
<figure>
  <img
    ...
    height="1024"
  >
  <figcaption>Deployment architecture for a Flask application on AWS using ECS and ECR. <a href="#core-components">See details below</a>.</figcaption>
</figure>
...
- **Security Groups:** Act as virtual firewalls to control inbound and outbound traffic for the ECS tasks.
