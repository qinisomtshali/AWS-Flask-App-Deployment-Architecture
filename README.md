...
<figure>
  <!-- Optimize Largest Contentful Paint (LCP) by prioritizing hero image and removing redundant loading="eager" (browser default). Explicit dimensions prevent Cumulative Layout Shift (CLS). -->
  <img
