...
<figure>
  <!--
    Optimization: Added fetchpriority="high" to prioritize the hero image for Largest Contentful Paint (LCP).
    Explicit width/height and decoding="async" are maintained to prevent Cumulative Layout Shift (CLS).
  -->
  <img
