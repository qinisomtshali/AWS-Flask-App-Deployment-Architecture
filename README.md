...
<figure>
  <img
    ...
    height="1024"
  >
  <figcaption>Deployment architecture for a Flask application on AWS using ECS and ECR. See <a href="#core-components">Core Components</a> and <a href="#deployment-workflow">Deployment Workflow</a> for details.</figcaption>
</figure>
...
- **Security Groups:** Act as virtual firewalls to control inbound and outbound traffic for the ECS service and ALB.
- **Virtual Private Cloud (VPC):** Provides a secure, isolated network environment for the application's infrastructure.
