...
<figure>
  <!--
    Optimization: Largest Contentful Paint (LCP)
    - fetchpriority="high": Signals the browser to prioritize this hero image for faster initial render.
    - Removed loading="eager": Redundant as it's the browser default for above-the-fold content.
  -->
  <img
