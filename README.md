...
<figure>
  <img
    ...
    alt="Cloud architecture diagram showing a user accessing a Flask app through an AWS Application Load Balancer, which routes to an ECS service with Docker containers pulling images from ECR."
    width="1024"
    height="1024"
    loading="eager"
    decoding="async"
