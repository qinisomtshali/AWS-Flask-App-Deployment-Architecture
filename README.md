...
<figure>
  <img
    ...
    height="1024"
  >
  <figcaption>Deployment architecture for a Flask application on AWS using ECS and ECR. See the <a href="#core-components">detailed text description</a>.</figcaption>
</figure>
...
- **Security Groups:** Act as virtual firewalls to control inbound and outbound traffic for the ECS tasks and Load Balancer.
- **VPC & Subnets:** Provide the isolated network environment where the application resources are securely deployed.
