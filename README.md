...
<figure>
  <!--
    ...
    - fetchpriority="high": Prioritizes the loading of this critical LCP asset.
    - Omit decoding="async": Ensures synchronous decoding for immediate paint.
    - Size reduced by ~18% (203KB -> 166KB) via metadata stripping and re-encoding.
  -->
  <img
